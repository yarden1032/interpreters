...
import { CExp, Exp, IfExp, LetrecExp, LetExp, ProcExp, Program, SetExp, isCExp, isClassExp } from '../src/L51-ast';
import { Binding, VarDecl } from "../src/L51-ast";
import { isBoolExp, isLitExp, isNumExp, isPrimOp, isStrExp, isVarRef } from "../src/L51-ast";
import { parseL5Exp } from "../src/L51-ast";
import { isAppExp, isDefineExp, isIfExp, isLetrecExp, isLetExp,
         isProcExp, isSetExp } from "../src/L51-ast";
...
export const applicativeEval = (exp: CExp, env: Env): Result<Value> =>
    ...
    isClassExp(exp) ? makeFailure("Not implemented") :
    exp;
